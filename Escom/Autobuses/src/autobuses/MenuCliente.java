...
public class MenuCliente extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Venta - Cliente");

        jLabel2.setFont(new java.awt.Font("Trebuchet MS", 0, 18)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(0, 102, 102));
        jLabel2.setText("AUTOBUSES");

        jLabel3.setText("Nombre:");

        jLabel4.setText("Número de Boletos:");

        jLabel5.setText("Número Maestros:");
        ...
        jLabel6.setText("Número Estudiantes");
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                        ...
                                        .addComponent(txtMaestros, javax.swing.GroupLayout.DEFAULT_SIZE, 94, Short.MAX_VALUE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        venta =  MainAutobuses.getVenta();
        JFrame frame = new JFrame("Información");
        venta.setNombre(txtNombre.getText());
        venta.setBoletos(Integer.parseInt(txtBoletos.getText()));
        venta.setMaestros(Integer.parseInt(txtMaestros.getText()));
        venta.setAlumnos(Integer.parseInt(txtEstudiantes.getText()));
        int respuesta = venta.calcularPrecio();
        if(respuesta == 0){
            JOptionPane.showMessageDialog(frame, "Algo esta mal, reingresa los valores");
        }else{
